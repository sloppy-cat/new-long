...
public class FreightController {
    ...
    @RequestMapping(value = "freights/{id}/selectfreight",
        ...
        produces = "application/json;charset=UTF-8")
    public Freight selectFreight(@PathVariable(value = "id") Integer id, @RequestBody SelectFreightCommand selectFreightCommand, HttpServletRequest request, HttpServletResponse response) throws Exception {
